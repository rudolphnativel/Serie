...
import com.formation.serie.repository.UtilisateurRepository;
...
class UtilisateurResourceIT {
    ...
    public static Utilisateur createEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur().nom(DEFAULT_NOM).duree(DEFAULT_DUREE);
        return utilisateur;
    }
    ...
    public static Utilisateur createUpdatedEntity(EntityManager em) {
        Utilisateur utilisateur = new Utilisateur().nom(UPDATED_NOM).duree(UPDATED_DUREE);
        return utilisateur;
    }
    ...
    void createUtilisateur() throws Exception {
        ...
        assertThat(testUtilisateur.getDuree()).isEqualTo(DEFAULT_DUREE);
    }
    ...
    void putNewUtilisateur() throws Exception {
        ...
        updatedUtilisateur.nom(UPDATED_NOM).duree(UPDATED_DUREE);
        ...
        assertThat(testUtilisateur.getDuree()).isEqualTo(UPDATED_DUREE);
    }
    ...
    void fullUpdateUtilisateurWithPatch() throws Exception {
        ...
        partialUpdatedUtilisateur.nom(UPDATED_NOM).duree(UPDATED_DUREE);
