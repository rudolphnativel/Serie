...
import com.formation.serie.repository.SerieRepository;
...
class SerieResourceIT {
    ...
    private static final Instant DEFAULT_DATE_HEURE_AJOUT = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_DATE_HEURE_AJOUT = Instant.now().truncatedTo(ChronoUnit.MILLIS);
    ...
    public static Serie createEntity(EntityManager em) {
        Serie serie = new Serie().nom(DEFAULT_NOM).dateHeureAjout(DEFAULT_DATE_HEURE_AJOUT);
        return serie;
    }
    ...
    public static Serie createUpdatedEntity(EntityManager em) {
        Serie serie = new Serie().nom(UPDATED_NOM).dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
        return serie;
    }
    ...
    void createSerie() throws Exception {
        ...
        assertThat(testSerie.getDateHeureAjout()).isEqualTo(DEFAULT_DATE_HEURE_AJOUT);
    }
    ...
    void getAllSeries() throws Exception {
        ...
        restSerieMockMvc
            ...
            .andExpect(jsonPath("$.[*].dateHeureAjout").value(hasItem(DEFAULT_DATE_HEURE_AJOUT.toString())));
    }
    ...
    void getSerie() throws Exception {
        ...
        restSerieMockMvc
            ...
            .andExpect(jsonPath("$.dateHeureAjout").value(DEFAULT_DATE_HEURE_AJOUT.toString()));
    }
    ...
    void putNewSerie() throws Exception {
        ...
        updatedSerie.nom(UPDATED_NOM).dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
        ...
        assertThat(testSerie.getDateHeureAjout()).isEqualTo(UPDATED_DATE_HEURE_AJOUT);
    }
    ...
    void partialUpdateSerieWithPatch() throws Exception {
        ...
        partialUpdatedSerie.dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
    ...
    void fullUpdateSerieWithPatch() throws Exception {
        ...
        partialUpdatedSerie.nom(UPDATED_NOM).dateHeureAjout(UPDATED_DATE_HEURE_AJOUT);
