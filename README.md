...
To build the final jar and optimize the testSerie application for production, run:
...
Then navigate to [http://localhost:8480](http://localhost:8480) in your browser.
